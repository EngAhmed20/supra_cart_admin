...
abstract class BaseApiServices{
  ...
  Future<Either<Failure, dynamic>> patchData({required String path, Map<String, dynamic>? data,String?token});
  Future<Either<Failure, dynamic>> deleteData({required String path,String? token});
