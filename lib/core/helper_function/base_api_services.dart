...
abstract class BaseApiServices{
  Future<Either<Failure, dynamic>> getData({required String path,Map<String, dynamic>? queryParameters});
  Future<Either<Failure, dynamic>> postData({required String path, Map<String, dynamic>? data,Map<String, dynamic>? queryParameters});
